...
namespace MHServerEmu.Games.GameData.Prototypes.AI
{
    ...
    public enum PropertyOperatorType            // Gazillion::s_checkPropOperatorTypeLookupTable and Gazillion::s_checkBBOperatorTypeLookupTable
    {
        EqualTo,
        NotEqualTo,
        GreaterThan,
    ...
    public class BehaviorDecoratorPrototype : BehaviorTreeNodePrototype
    {
        ...
        public BehaviorDecoratorType DecoratorType { get; protected set; }
        public CurveId LoopCount { get; protected set; }
        public BehaviorDecoratorLoopCurveIndexType LoopCurveIndex { get; protected set; }
    }
    ...
    {
        public OwnerStateType OwnerStateToCheck { get; protected set; }
