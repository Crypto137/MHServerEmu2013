...
namespace MHServerEmu.Games.GameData
{
    ...
    {
        public const byte CalligraphyExportVersion = 10;     // 10 for versions 1.9-1.17, 11 for 1.18+
        ...
        private bool LoadDirectoryFromFile(DataDirectoryEntry directoryEntry)
        {
            ...
            if (!Verify.IsTrue(reader.Read(out short numEntries))) return false;    // V10_NOTE: This is Int16 instead of Int32
