...
namespace MHServerEmu.Games.Network
{
    public class AreaOfInterest
    {
        ...
        public AreaOfInterest(PlayerConnection playerConnection)
        {
            _playerConnection = playerConnection;
            _game = playerConnection.Game;

            SetAOIVolume(AOIVolumeDefault);
        }
        ...
        public void InitializePlayerView(PrototypeId cameraSettingsProtoRef)
        {
            ...
            // V10_NOTE: No CameraSettingCollectionPrototype in 1.10
            // GameDatabase.GlobalsPrototype.PlayerCameraSettings?

            CameraSettingPrototype cameraSettingProto = cameraSettingsProtoRef.As<CameraSettingPrototype>();
            if (cameraSettingProto == null) return;
        ...
        {
            //Region?.UpdateLastVisitedTime();  V10_TODO
            _currentFrame++;
        ...
        private void AddCell(Cell cell)
        {
            ...
            var builder = NetMessageCellCreate.CreateBuilder()
                ...
                .SetDepth(0)    // V10_NOTE: Figure out what this is and if it's important
        ...
        private void RemoveEntity(Entity entity)
        {
            ...
            // Notify client
            SendMessage(NetMessageEntityDestroy.CreateBuilder()
                .SetIdEntity(entity.Id)
#if BUILD_1_10_0_69
                .SetPrototypeId((ulong)entity.PrototypeDataRef)
                // TODO: Add other debug data
#endif
                .Build());
        }
