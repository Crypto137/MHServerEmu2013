...
namespace MHServerEmu.Games.Network
{
    ...
    public sealed class RepVar_byte : RepVar<byte>
    {
    ...
    public sealed class RepVar_uint : RepVar<uint>
    {
        protected override bool SerializeValue(Archive archive)
        {
            return Serializer.Transfer(archive, ref _value);
    ...
    public sealed class RepVar_Vector3 : RepVar<Vector3>
    {
        protected override bool SerializeValue(Archive archive)
        {
            return Serializer.Transfer(archive, ref _value);
    ...
    public sealed class RepVar_PrototypeDataRef : RepVar<PrototypeId>
    {
        protected override bool SerializeValue(Archive archive)
        {
            return Serializer.Transfer(archive, ref _value);
