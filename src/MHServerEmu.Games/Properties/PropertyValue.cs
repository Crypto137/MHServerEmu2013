        ...
        */
        ...
        public string Print(PropertyDataType type)
        {
            switch (type)
            {
                ...
                //case PropertyDataType.Int21Vector3: return ToVector3().ToString();    V10_TODO
        ...
        //public static implicit operator PropertyValue(Vector3 value) => new(value);   V10_TODO
        ...
        //public static implicit operator Vector3(PropertyValue value) => value.ToVector3();    // V10_TODO
